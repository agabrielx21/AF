...
// x la y, iar cand se respecta aceasta conditie, crestem frecventa distantei de la nodul curent pana la nodul x pentru a testa asfel conditia urmatoare:
// Nodurile dorite sunt cele care sunt singure pe nivel, deci frecventa distantei de la nod la X va fi = 1.
// (luand in considerare numai nodurile care respecta suma de mai sus) pentru ca "obliga" toate lanturile optime sa treaca prin ele.
